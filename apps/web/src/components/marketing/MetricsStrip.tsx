import { ChartCanvas, Container, Section } from '../ui';
    ...
    <Section id="metrics" class="pt-0">
      <Container>
        ...
        <div class="grid gap-4 lg:grid-cols-3">
          <div class="rounded-2xl border border-[var(--color-line)] bg-[var(--color-card)] p-5 lg:col-span-2">
          ...
          <div class="rounded-2xl border border-[var(--color-line)] bg-[var(--color-card)] p-5">
