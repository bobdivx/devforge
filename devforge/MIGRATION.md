...
Ce document définit **quand un domaine est prêt à couper le legacy**, l’**état actuel** de la migration, et le **plan d’organisation** du répertoire `devforge/` pour le nettoyage final.
...
| **services** | ⚠️ | ⚠️ | ✅ | ❌ | ❌ | ⚠️ | ✅ | ⚠️ | ✅ | ✅ | ❌ | Liste core ; pas de panneau détail dédié |
...
| **settings** (projets) | ✅ | ✅ | ✅ | ✅ | ✅ | ➖ | ✅ | ⚠️ | ✅ | ✅ | ❌ | CRUD projets/environnements |
| **settings** (serveurs liste) | ✅ | ✅ | ✅ | ❌ | ❌ | ➖ | ✅ | ⚠️ | ✅ | ✅ | ❌ | Liste dans onglet paramètres |
| **settings** (équipe) | ✅ | ✅ | ✅ | ❌ | ❌ | ➖ | ✅ | ⚠️ | ✅ | ✅ | ❌ | Membres lecture seule |
| **settings** (instance) | ✅ | ✅ | ✅ | ❌ | ❌ | ➖ | ✅ | ⚠️ | ✅ | ✅ | ❌ | Instance/avancé/email/oauth/updates lecture seule |
| **settings** (notifications) | ✅ | ✅ | ✅ | ⚠️ | ⚠️ | ➖ | ✅ | ⚠️ | ✅ | ✅ | ❌ | Événements + enabled éditables ; identifiants legacy |
| **settings** (variables) | ✅ | ✅ | ✅ | ⚠️ | ⚠️ | ➖ | ✅ | ✅ | ✅ | ✅ | ❌ | CRUD par portée ; secrets masqués |
...
| **shared-variables** | ✅ | ✅ | ✅ | ⚠️ | ⚠️ | ➖ | ✅ | ✅ | ✅ | ✅ | ❌ | CRUD par portée |
| **team** | ✅ | ✅ | ✅ | ⚠️ | ⚠️ | ➖ | ✅ | ✅ | ✅ | ✅ | ❌ | CRUD équipe + membres + invitations |
| **security** | ✅ | ✅ | ⚠️ | ❌ | ❌ | ➖ | ✅ | ⚠️ | ✅ | ✅ | ❌ | Sous-routes `/security/*` |
| **terminal** | ✅ | ✅ | ⚠️ | ❌ | ❌ | ⚠️ | ✅ | ❌ | ⚠️ | ✅ | ❌ | Config WS ; pas xterm interactif |
| **sources** | ✅ | ✅ | ✅ | ❌ | ❌ | ➖ | ✅ | ❌ | ✅ | ✅ | ❌ | Liste GitHub ; détail legacy |
| **destinations** | ✅ | ✅ | ✅ | ⚠️ | ⚠️ | ➖ | ✅ | ⚠️ | ✅ | ✅ | ❌ | CRUD + resources ; scan réseaux legacy |
| **tags** | ✅ | ✅ | ✅ | ⚠️ | ⚠️ | ➖ | ✅ | ✅ | ✅ | ✅ | ❌ | CRUD + redeploy massif ; attachement ressources via fiche app/service |
| **servers** (détail) | ✅ | ⚠️ | ⚠️ | ❌ | ❌ | ➖ | ✅ | ⚠️ | ✅ | ✅ | ❌ | `/server/{uuid}/*` ; onglets → legacy |
| **projects** (routes legacy) | ✅ | ⚠️ | ⚠️ | ⚠️ | ⚠️ | ➖ | ✅ | ⚠️ | ✅ | ✅ | ❌ | `/project/*` redirige vers settings/apps |
| **storage** (`/storages`) | ✅ | ✅ | ✅ | ✅ | ✅ | ➖ | ✅ | ⚠️ | ✅ | ✅ | ❌ | Page standalone + CRUD S3 (vague 1) |
| **subscription** | ✅ | ✅ | ⚠️ | ❌ | ❌ | ➖ | ✅ | ❌ | ❌ | ✅ | ❌ | Bootstrap cloud ; Stripe legacy |
| **onboarding** | ✅ | ✅ | ⚠️ | ❌ | ❌ | ➖ | ✅ | ❌ | ❌ | ✅ | ❌ | Lien wizard Coolify |
| **authentication** | ⚠️ | ❌ | ⚠️ | ⚠️ | ❌ | ➖ | ✅ | ⚠️ | ⚠️ | ⚠️ | ❌ | Fortify hors shell DevForge |
...
```bash
# Front
cd devforge && npm test && npm run build
...
### Répertoire Laravel (hors `devforge/`)
...
| Option | Verdict |
|--------|---------|
| Sous-dossier `coolify/devforge/` | ✅ Actuel — maintenu |
| Monorepo aplati (`apps/devforge` + `backend/`) | Envisager après ~70 % domaines en **X** |
| Repo Git `devforge` séparé | ❌ Pas maintenant — coupling auth, API, déploiement Docker |

Un repo séparé n’apporte pas de propreté suffisante pour compenser la coordination API/UI et le déploiement. La propreté vient de la **structure interne** (`MIGRATION.md` → structure cible) et du retrait progressif du legacy.
...
|---|---------|-----------------|--------|
| 1 | **storage** (`/storages`) | Page standalone + `GET /s3-storages/{uuid}` | ✅ Fait |
| 2 | **settings / projets** | Déjà CRUD — retirer bannières, tests UI | À faire |
| 3 | **profile** | ✅ Compte + apparence ; 2FA/mot de passe legacy Fortify |

### Vague 2 — Lecture OK, API écriture à ajouter

| # | Domaine | Travail |
|---|---------|---------|
| 4 | **notifications** | `PUT` événements + enabled ✅ ; identifiants canal (SMTP/webhook) legacy | Partiel |
| 5 | **shared-variables** | CRUD par scope ✅ | Partiel |
| 6 | **destinations** | CRUD + resources ✅ ; scan réseaux legacy | Partiel |
| 7 | **tags** | ✅ CRUD + redeploy massif |
| 8 | **team** | ✅ CRUD équipe + membres + invitations |

### Vague 3 — Sous-pages & actions lourdes

| # | Domaine | Travail |
|---|---------|---------|
| 9 | **servers** | Métriques, resources, proxy (incrémental) |
| 10 | **applications** | Sous-routes logs, env, webhooks, terminal |
| 11 | **databases** | Backups UI complète |
| 12 | **services** | Panneau détail + actions |
| 13 | **terminal** | xterm interactif |

### Vague 4 — Cloud & gouvernance

| # | Domaine | Travail |
|---|---------|---------|
| 14 | **subscription** | Stripe / plans |
| 15 | **onboarding** | Wizard multi-étapes |
| 16 | **authentication** | Shell DevForge login (optionnel) |
| 17 | **admin** | Cloud/dev stats |
