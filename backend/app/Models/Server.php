...
class Server extends BaseModel
{
    ...
    {
        $banner =
            "# This file is generated by DevForge, do not edit it manually.\n".
    ...
    public function setupDynamicProxyConfiguration()
    {
        ...
        if ($this->proxyType() === ProxyTypes::TRAEFIK->value) {
            ...
            if (empty($settings->fqdn) || (isCloud() && $this->id !== 0) || ! $this->isLocalhost()) {
                ...
                $yaml =
                    "# This file is automatically generated by DevForge.\n".
...
$schema://$host {
    ...
    reverse_proxy coolify:8080
        ...
        $this->setupSsoProxyConfiguration();
    }

    public function setupSsoProxyConfiguration(): void
    {
        if ($this->proxyType() !== ProxyTypes::TRAEFIK->value) {
            return;
        }
        ...
        $dynamic_config_path = $this->proxyPath().'/dynamic';
        $file = $dynamic_config_path.'/devforge-sso.yaml';

        if (! SsoProtection::isAppsProtectionConfigured()) {
            instant_remote_process([
                "rm -f $file",
            ], $this);
        ...
        $yaml = "# This file is automatically generated by DevForge.\n".
            "# Do not edit it manually (only if you know what are you doing).\n\n".
            Yaml::dump(SsoProtection::traefikDynamicConfiguration(server: $this), 12, 2);
        $base64 = base64_encode($yaml);
    ...
    public function loadUnmanagedContainers(): Collection
    {
        if ($this->isFunctional()) {
            ...
            $containers = $containers->map(function ($container) {
                ...
                if (! str($labels)->contains('devforge.managed')) {
                    return $container;
                }
    ...
    public function databases()
    {
        ...
        $libsqls = StandaloneLibsql::where($destinationCondition)->get();
    ...
    {
        $attributes = [
            'name' => $id === 0 ? 'localhost-devforge' : 'devforge',
