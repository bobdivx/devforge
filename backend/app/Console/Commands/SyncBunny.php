...
class SyncBunny extends Command
{
    ...
    public function handle()
    {
        ...
        // Laravel lives in backend/; compose/scripts/docs live at the monorepo root.
        $backend_dir = base_path();
        $repo_root = realpath($backend_dir.DIRECTORY_SEPARATOR.'..') ?: $backend_dir;
        ...
        $compose_file_location = "$repo_root/$compose_file";
        $compose_file_prod_location = "$repo_root/$compose_file_prod";
        $install_script_location = "$repo_root/scripts/install.sh";
        $upgrade_script_location = "$repo_root/scripts/upgrade.sh";
        $upgrade_postgres_script_location = "$repo_root/scripts/upgrade-postgres.sh";
        $production_env_location = "$backend_dir/.env.production";
        $versions_location = "$backend_dir/$versions";
        ...
        try {
            if ($nightly) {
                ...
                $compose_file_location = "$repo_root/docs/other/nightly/$compose_file";
                $compose_file_prod_location = "$repo_root/docs/other/nightly/$compose_file_prod";
                $production_env_location = "$repo_root/docs/other/nightly/$production_env";
                $upgrade_script_location = "$repo_root/docs/other/nightly/$upgrade_script";
                $upgrade_postgres_script_location = "$repo_root/docs/other/nightly/$upgrade_postgres_script";
                $install_script_location = "$repo_root/docs/other/nightly/$install_script";
                $versions_location = "$repo_root/docs/other/nightly/$versions";
            }
            ...
            if ($only_template) {
                ...
                Http::pool(fn (Pool $pool) => [
                    $pool->storage(fileName: "$backend_dir/templates/$service_template")->put("/$bunny_cdn_storage_name/$bunny_cdn_path/$service_template"),
