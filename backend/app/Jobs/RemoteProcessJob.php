...
class RemoteProcessJob implements ShouldBeEncrypted, ShouldQueue
{
    ...
    {
        Log::channel('scheduled-errors')->error('RemoteProcessJob permanently failed', [
            'job' => 'RemoteProcessJob',
