...
class AgentToolClassification
{
    ...
    public static function builtinMap(): array
    {
        ...
        $definitions = [
            ...
            'apply_docker_image_update' => $destructive,
            ...
            'yield_wait' => ['isReadOnly' => true, 'isDestructive' => false, 'isConcurrencySafe' => true, 'runtimeProfile' => 'coordinator'],
            ...
            'todo_write' => $neutral,
            'web_search' => $readOnly,
            'browser_fetch' => $readOnly,
            'browser_smoke' => $readOnly,
            'checkpoint_list' => $readOnly,
            'checkpoint_rollback' => $destructive,
            'mission_list' => $readOnly,
            'mission_show' => $readOnly,
            'mission_create' => $neutral,
            'mission_claim' => $neutral,
            ...
            'list_github_workflows' => $readOnly,
            'list_github_workflow_jobs' => $readOnly,
            'get_github_workflow_job_logs' => $readOnly,
            'list_github_commits' => $readOnly,
            'rerun_github_workflow_run' => $destructive,
            'dispatch_github_workflow' => $destructive,
