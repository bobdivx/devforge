...
class Reachable extends CustomEmailNotification
{
    ...
    public function toMail(): MailMessage
    {
        ...
        $mail->subject(product_name().": Server ({$this->server->name}) revived.");
    ...
    {
        return [
            'message' => product_name().": Server '{$this->server->name}' revived. All automations & integrations are turned on again!",
        ];
    }
