...
class BackupSuccess extends CustomEmailNotification
{
    ...
    public function toMail(): MailMessage
    {
        ...
        $mail->subject(product_name().": Backup successfully done for {$this->database->name}");
    ...
    {
        $message = product_name().": Database backup for {$this->name} (db:{$this->database_name}) with frequency of {$this->frequency} was successful.";
