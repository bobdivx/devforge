...
it('renders the DevForge login page when DevForge is enabled', function () {
    ...
    $this->get('/login')
        ...
        ->assertSee('devforge-auth-ecosystem', false)
        ->assertSee('devforge-auth-constellation', false)
        ->assertSee('devforge-auth-shell-split', false)
        ->assertSee('Écosystème d’apps connecté', false)
        ->assertSee('Laissez l’IA travailler dans vos outils', false)
        ->assertSee('action="/login"', false)
        ->assertSee('name="email"', false)
        ->assertSee('name="password"', false)
        ->assertSee('name="_token"', false)
        ->assertSee('bientôt', false)
        ->assertDontSee('href="https://slack.com"', false)
...
it('renders the DevForge register page when DevForge is enabled', function () {
    ...
    $this->get('/register')
        ...
        ->assertDontSee('devforge-auth-ecosystem', false)
        ->assertDontSee('devforge-auth-shell-split', false)
        ->assertSee('devforge-auth-page', false)
        ->assertSee('devforge-auth-logo', false)
        ->assertSee('/css/devforge-auth.css', false)
        ->assertSee('/favicon.ico', false)
