    ...
    <div class="flex items-center gap-2">
        ...
        @if (!$healthCheckEnabled)
            <x-modal-confirmation title="Confirm Healthcheck Enable?" buttonTitle="Enable Healthcheck"
                ...
                warningMessage="If the health check fails, your application will become inaccessible. Please review the <a href='https://github.com/bobdivx/devforge' target='_blank' class='underline text-white'>Health Checks</a> guide before proceeding!"
