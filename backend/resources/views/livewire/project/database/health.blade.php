    ...
    <div class="flex items-center gap-2">
        ...
        @if (!$healthCheckEnabled)
            <x-modal-confirmation title="Confirm Healthcheck Enable?" buttonTitle="Enable Healthcheck"
                ...
                warningMessage="If the health check fails, this database will be marked unhealthy. Please review the <a href='https://github.com/bobdivx/devforge' target='_blank' class='underline text-white'>Health Checks</a> guide before proceeding!"
