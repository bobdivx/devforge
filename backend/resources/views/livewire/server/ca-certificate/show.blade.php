<div>
    <x-slot:title>
        {{ data_get_str($server, 'name')->limit(10) }} > CA Certificate | DevForge
    </x-slot>
                    ...
                    <div class="flex gap-2">
                        <x-modal-confirmation title="Confirm changing of CA Certificate?" buttonTitle="Save"
                            submitAction="saveCaCertificate" :actions="[
                                'This will overwrite the existing instance CA certificate with your custom CA certificate.',
                            ...
                            confirmationText="instance-ca.crt" shortConfirmationLabel="CA Certificate Path"
                        ...
                        <x-modal-confirmation title="Confirm Regenerate Certificate?" buttonTitle="Regenerate "
                            submitAction="regenerateCaCertificate" :actions="[
                                'This will generate a new instance CA certificate and replace the existing one.',
            ...
            <div class="space-y-4">
                <div class="text-sm">
                    ...
                    <ul class="list-disc pl-5 space-y-1">
                        <li>Mount this CA certificate of DevForge into all containers that need to connect to one of
                        ...
                        <li>Read more when and why this is needed <a class="underline dark:text-white"
                                href="https://github.com/bobdivx/devforge" target="_blank">here</a>.</li>
                    </ul>
                </div>
                <div class="relative">
                    <x-forms.copy-button :text="'- '.config('constants.coolify.base_config_path').'/ssl/ca.crt:/etc/ssl/certs/ca.crt:ro'" />
                </div>
            </div>
            <div>
