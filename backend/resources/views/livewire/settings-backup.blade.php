<div>
    ...
    <div class="flex flex-col">
        ...
        <div class="pb-4">Backup configuration for DevForge instance.</div>
        <div>
            @if ($server->isFunctional())
                ...
                @else
                    To configure automatic backup for your DevForge instance, you first need to add a database resource
                    into DevForge.
                    <x-forms.button class="mt-2" wire:click="addDevForgeDatabase">Configure Backup</x-forms.button>
                @endif
            @else
