<div>
    <x-slot:title>
        ...
        <div class="flex gap-2 items-end subtitle">
            ...
            <x-helper
                helper="If you're having trouble connecting to your server, make sure that the port is open.<br><br><a class='underline' href='https://github.com/bobdivx/devforge' target='_blank'>Documentation</a>"></x-helper>
        </div>
