...
export function AgentRunsView({ agent, initialRunUuid = null, onAgentUpdated }: Props) {
    ...
    }, [agent.status, isTracking, selectedRunUuid, agent.uuid, runs]);
    ...
    return (
        <div class="flex min-h-0 min-w-0 flex-1 flex-col">
            {hasLiveRun && (
                <div class="flex shrink-0 items-center gap-2 sm:gap-3 border-b border-success/30 bg-success/10 px-3 py-2.5 sm:px-3 sm:px-4">
            ...
            <div class="flex shrink-0 items-center justify-between gap-2 border-b border-base-300 bg-base-100 px-3 py-2.5 sm:px-3 sm:px-4">
            ...
            <div class="flex min-h-0 min-w-0 flex-1 flex-col lg:flex-row">
                <aside class="max-h-[min(32vh,14rem)] shrink-0 overflow-y-auto border-b border-base-300 bg-base-200/20 lg:max-h-none lg:w-80 lg:max-w-[40%] lg:border-b-0 lg:border-e">
                    {loading ? (
                        <div class="flex items-center justify-center px-3 sm:px-4 py-10 text-xs text-base-content/50">
                ...
                <div class="min-h-0 min-w-0 flex-1 overflow-y-auto bg-base-100 p-3 sm:p-4">
                    {displayRun ? (
                        ...
                        <div class="flex h-full min-h-[16rem] flex-col items-center justify-center gap-2.5 sm:gap-3 md:gap-2.5 sm:gap-3 md:gap-4 px-6 py-12 text-center">
