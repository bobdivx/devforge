...
const nativeSections = new Set<ServerSectionId>([
    'overview',
    'files',
    'resources',
    'destinations',
    ...
    return (
        <div class="grid gap-5">
            ...
            {activeSection === 'overview' ? (
                ...
                <ServerResourcesPanel serverUuid={serverUuid} />
            ) : activeSection === 'destinations' ? (
                <ServerDestinationsPanel serverUuid={serverUuid} />
            ) : activeSection === 'docker-cleanup' ? (
